...
PostgreSQL, MySQL/MariaDB и SQLite встроены изначально. Встроенный драйвер PostgreSQL устарел: вместо него используется [плагин PostgreSQL](https://github.com/TabularisDB/tabularis-postgresql-plugin), который Tabularis устанавливает автоматически. Всё остальное — это плагины; ниже показано, на какой стадии находится каждая интеграция сегодня, в соответствии с [покрытием драйверов и плагинов](https://tabularis.dev/#driver-coverage) на сайте.

[ClickHouse](https://github.com/TabularisDB/tabularis-clickhouse-plugin) (выпущено), [Cloudflare D1](https://github.com/josejorge/tabularis_cloudflare_d1_plugin) (выпущено), [Cloudflare D1 (HTTP API)](https://github.com/GabrielMalava/cloudflare-tabularis) (выпущено), [DM / Dameng](https://github.com/haos666/tabularis-dameng-plugin) (выпущено), [DuckDB](https://github.com/TabularisDB/tabularis-duckdb-plugin) (выпущено), [DynamoDB](https://github.com/TabularisDB/tabularis-dynamodb-plugin) (выпущено), [Elasticsearch](https://github.com/TabularisDB/tabularis-elasticsearch-plugin) (выпущено), [Firestore](https://codeberg.org/NewtTheWolf/firestore-tabularis) (выпущено), [IBM Db2](https://github.com/TabularisDB/tabularis-db2-plugin) (выпущено), [IBM Informix](https://github.com/danielnuld/tabularis-informix-plugin) (выпущено), [LibSQL / Turso](https://github.com/TabularisDB/tabularis-libsql-plugin) (выпущено), [MongoDB](https://github.com/danielnuld/tabularis-mongodb-plugin) (выпущено), [MongoDB Atlas](https://github.com/TabularisDB/tabularis-mongodb-plugin) (выпущено), [Oracle](https://github.com/TabularisDB/tabularis-oracle-plugin) (выпущено), [Redis (Go)](https://github.com/gzamboni/tabularis-redis-plugin-go) (выпущено), [Redis (Rust)](https://github.com/nicholas-papachriston/tabularis-redis-plugin) (выпущено), [SQL Server](https://github.com/TabularisDB/tabularis-sqlserver-plugin) (выпущено), [CSV Folder](https://github.com/TabularisDB/tabularis-csv-plugin) (выпущено), [Google Sheets](https://github.com/TabularisDB/tabularis-google-sheets-plugin) (выпущено), [HackerNews](https://github.com/TabularisDB/tabularis-hackernews-plugin) (выпущено), Google BigQuery (закреплено), Meilisearch (закреплено), Amazon Redshift (запланировано), CockroachDB (запланировано), TiDB (запланировано), Snowflake (скоро), Cassandra (открыто), Etcd (открыто), Firebird (открыто), ScyllaDB (открыто), SQL Anywhere (открыто), SurrealDB (открыто), Trino / Presto (открыто).
