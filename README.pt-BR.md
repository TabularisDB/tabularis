...
PostgreSQL, MySQL/MariaDB e SQLite já vêm integrados. O driver PostgreSQL integrado está obsoleto em favor do [plugin PostgreSQL](https://github.com/TabularisDB/tabularis-postgresql-plugin), que o Tabularis instala automaticamente. Tudo o mais é um plugin — a cobertura atual (espelhando a [cobertura de drivers e plugins](https://tabularis.dev/#driver-coverage) no site):

[ClickHouse](https://github.com/TabularisDB/tabularis-clickhouse-plugin) (disponível), [Cloudflare D1](https://github.com/josejorge/tabularis_cloudflare_d1_plugin) (disponível), [Cloudflare D1 (HTTP API)](https://github.com/GabrielMalava/cloudflare-tabularis) (disponível), [DM / Dameng](https://github.com/haos666/tabularis-dameng-plugin) (disponível), [DuckDB](https://github.com/TabularisDB/tabularis-duckdb-plugin) (disponível), [DynamoDB](https://github.com/TabularisDB/tabularis-dynamodb-plugin) (disponível), [Elasticsearch](https://github.com/TabularisDB/tabularis-elasticsearch-plugin) (disponível), [Firestore](https://codeberg.org/NewtTheWolf/firestore-tabularis) (disponível), [IBM Db2](https://github.com/TabularisDB/tabularis-db2-plugin) (disponível), [IBM Informix](https://github.com/danielnuld/tabularis-informix-plugin) (disponível), [LibSQL / Turso](https://github.com/TabularisDB/tabularis-libsql-plugin) (disponível), [MongoDB](https://github.com/danielnuld/tabularis-mongodb-plugin) (disponível), [MongoDB Atlas](https://github.com/TabularisDB/tabularis-mongodb-plugin) (disponível), [Oracle](https://github.com/TabularisDB/tabularis-oracle-plugin) (disponível), [Redis (Go)](https://github.com/gzamboni/tabularis-redis-plugin-go) (disponível), [Redis (Rust)](https://github.com/nicholas-papachriston/tabularis-redis-plugin) (disponível), [SQL Server](https://github.com/TabularisDB/tabularis-sqlserver-plugin) (disponível), [CSV Folder](https://github.com/TabularisDB/tabularis-csv-plugin) (disponível), [Google Sheets](https://github.com/TabularisDB/tabularis-google-sheets-plugin) (disponível), [HackerNews](https://github.com/TabularisDB/tabularis-hackernews-plugin) (disponível), Google BigQuery (reivindicado), Meilisearch (reivindicado), Amazon Redshift (planejado), CockroachDB (planejado), TiDB (planejado), Snowflake (em breve), Cassandra (aberto), Etcd (aberto), Firebird (aberto), ScyllaDB (aberto), SQL Anywhere (aberto), SurrealDB (aberto), Trino / Presto (aberto).
