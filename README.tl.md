...
Sinusuportahan ng UI ng app ang Ingles, Italyano, Espanyol, Tsino (Simplified), Pranses, Aleman, Hapones, Ruso, Tagalog, at Portuges (Brazilian).
...
Built-in ang PostgreSQL, MySQL/MariaDB at SQLite. Deprecated na ang built-in na PostgreSQL driver pabor sa [PostgreSQL plugin](https://github.com/TabularisDB/tabularis-postgresql-plugin), na awtomatikong ini-install ng Tabularis. Ang lahat ng iba ay plugin; ipinapakita sa ibaba kung nasaan ang bawat integration ngayon, ayon sa [driver coverage at plugins](https://tabularis.dev/#driver-coverage) sa website.

[ClickHouse](https://github.com/TabularisDB/tabularis-clickhouse-plugin) (released), [Cloudflare D1](https://github.com/josejorge/tabularis_cloudflare_d1_plugin) (released), [Cloudflare D1 (HTTP API)](https://github.com/GabrielMalava/cloudflare-tabularis) (released), [DM / Dameng](https://github.com/haos666/tabularis-dameng-plugin) (released), [DuckDB](https://github.com/TabularisDB/tabularis-duckdb-plugin) (released), [DynamoDB](https://github.com/TabularisDB/tabularis-dynamodb-plugin) (released), [Elasticsearch](https://github.com/TabularisDB/tabularis-elasticsearch-plugin) (released), [Firestore](https://codeberg.org/NewtTheWolf/firestore-tabularis) (released), [IBM Db2](https://github.com/TabularisDB/tabularis-db2-plugin) (released), [IBM Informix](https://github.com/danielnuld/tabularis-informix-plugin) (released), [LibSQL / Turso](https://github.com/TabularisDB/tabularis-libsql-plugin) (released), [MongoDB](https://github.com/danielnuld/tabularis-mongodb-plugin) (released), [MongoDB Atlas](https://github.com/TabularisDB/tabularis-mongodb-plugin) (released), [Oracle](https://github.com/TabularisDB/tabularis-oracle-plugin) (released), [Redis (Go)](https://github.com/gzamboni/tabularis-redis-plugin-go) (released), [Redis (Rust)](https://github.com/nicholas-papachriston/tabularis-redis-plugin) (released), [SQL Server](https://github.com/TabularisDB/tabularis-sqlserver-plugin) (released), [CSV Folder](https://github.com/TabularisDB/tabularis-csv-plugin) (released), [Google Sheets](https://github.com/TabularisDB/tabularis-google-sheets-plugin) (released), [HackerNews](https://github.com/TabularisDB/tabularis-hackernews-plugin) (released), Google BigQuery (claimed), Meilisearch (claimed), Amazon Redshift (scoped), CockroachDB (scoped), TiDB (scoped), Snowflake (paparating), Cassandra (open), Etcd (open), Firebird (open), ScyllaDB (open), SQL Anywhere (open), SurrealDB (open) at Trino / Presto (open).
