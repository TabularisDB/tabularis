...
This project is indexed by GitNexus as **tabularis** (11249 symbols, 21161 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
