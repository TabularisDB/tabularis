...
const buttonClass =
  "flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-base border border-strong text-sm text-secondary hover:text-accent hover:border-accent-primary/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed";
...
const dangerButtonClass =
  "flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-base border border-strong text-sm text-secondary hover:text-accent-error hover:border-accent-error/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {phase === "unreachable" && (
          <p className="mt-2 text-xs text-accent-warning flex items-start gap-1.5">
